    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='名字')),
                ('last_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='姓')),
