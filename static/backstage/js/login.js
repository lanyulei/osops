layui.use(['jquery','common','layer','form','larryMenu'],function(){
    ...
    common.larryCmsLoadJq('/static/common/plus/jquery.supersized.min.js', function() {
        $.supersized({
            ...
            slide_links: 'blank',
            slides: [{
                image: '/static/backstage/images/login/1.jpg'
            }, {
                image: '/static/backstage/images/login/2.jpg'
            }, {
                image: '/static/backstage/images/login/3.jpg'
            }]
        });
    });

    // form.on('submit(submit)',function(data){
    //     if(data.field.username == 'larry' && data.field.password == 'larry'){
